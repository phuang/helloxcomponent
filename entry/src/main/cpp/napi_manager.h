...
class NapiManager {
  ...
  void set_controller(Napi::Reference<Napi::Object> controller) { controller_ = std::move(controller); }

  OH_NativeXComponent *root_view() const { return root_view_; }
  ...
  void SetRootViewXComp(OH_NativeXComponent *root_view) { root_view_ = root_view; }
